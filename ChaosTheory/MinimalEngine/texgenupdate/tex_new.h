...
#ifdef INCLUDE_TEX_Envmap
	void Envmap(RGBA*, RGBA*, COMMAND*);
#endif

#ifdef INCLUDE_TEX_Plasma
	void Plasma(RGBA*, RGBA*, COMMAND*);
#endif

#ifdef INCLUDE_TEX_SubPlasma
	void SubPlasma(RGBA*, RGBA*, COMMAND*);
#endif

#ifdef INCLUDE_TEX_Text
	void Text(RGBA*, RGBA*, COMMAND*);
#endif
	
#ifdef INCLUDE_TEX_Map
	void Map(RGBA*, RGBA*, COMMAND*);
#endif

#ifdef INCLUDE_TEX_Blur
	void Blur(RGBA*, RGBA*, COMMAND*);
#endif

#ifdef INCLUDE_TEX_DirBlur
	void DirBlur(RGBA*, RGBA*, COMMAND*);
#endif

#ifdef INCLUDE_TEX_FractalPlasma
	void FractalPlasma(RGBA*, RGBA*, COMMAND*);
#endif

#ifdef INCLUDE_TEX_Colorize
	void Colorize(RGBA*, RGBA*, COMMAND*);
#endif

#ifdef INCLUDE_TEX_Emboss
	void Emboss(RGBA*, RGBA*, COMMAND*);
#endif

#ifdef INCLUDE_TEX_Shade
	void Shade(RGBA*, RGBA*, COMMAND*);
#endif

#ifdef INCLUDE_TEX_Brightness
	void Brightness(RGBA*, RGBA*, COMMAND*);
#endif

#ifdef INCLUDE_TEX_Copy
	void Copy(RGBA*, RGBA*, COMMAND*);
#endif

#ifdef INCLUDE_TEX_Cells
	void Cells(RGBA*, RGBA*, COMMAND*);
#endif

#ifdef INCLUDE_TEX_Twirl
	void Twirl(RGBA*, RGBA*, COMMAND*);
#endif

#ifdef INCLUDE_TEX_SineDist
	void SineDist(RGBA*, RGBA*, COMMAND*);
#endif

#ifdef INCLUDE_TEX_Mix
	void Mix(RGBA*, RGBA*, COMMAND*);
#endif

#ifdef INCLUDE_TEX_MixMap
	void MixMap(RGBA*, RGBA*, COMMAND*);
#endif

#ifdef INCLUDE_TEX_Invert
	void Invert(RGBA*, RGBA*, COMMAND*);
#endif

#ifdef INCLUDE_TEX_Scale
	void Scale(RGBA*, RGBA*, COMMAND*);
#endif

#ifdef INCLUDE_TEX_SineColor
	void SineColor(RGBA*, RGBA*, COMMAND*);
#endif

#ifdef INCLUDE_TEX_Max
	void Max(RGBA*, RGBA*, COMMAND*);
#endif

#ifdef INCLUDE_TEX_HSV
	void HSV(RGBA*, RGBA*, COMMAND*);
#endif

#ifdef INCLUDE_TEX_Glass
	void Glass(RGBA*, RGBA*, COMMAND*);
#endif

#ifdef INCLUDE_TEX_Pixelize
	void Pixelize(RGBA*, RGBA*, COMMAND*);
#endif

#ifdef INCLUDE_TEX_Offset
	void Offset(RGBA*, RGBA*, COMMAND*);
#endif

#ifdef INCLUDE_TEX_Crystalize
	void Crystalize(RGBA*, RGBA*, COMMAND*);
#endif

#ifdef INCLUDE_TEX_Rectangle
	void Rectangle(RGBA*, RGBA*, COMMAND*);
#endif

#ifdef INCLUDE_TEX_Circle
	void Circle(RGBA*, RGBA*, COMMAND*);
#endif

#ifdef INCLUDE_TEX_Contrast
	void Contrast(RGBA*, RGBA*, COMMAND*);
#endif

#ifdef INCLUDE_TEX_MakeMaterial
	void MakeMaterial(RGBA*, RGBA*, COMMAND*);
#endif

#ifdef INCLUDE_TEX_Gradient
	void Gradient(RGBA*, RGBA*, COMMAND*);
#endif

#ifdef INCLUDE_TEX_Rotozoom
	void Rotozoom(RGBA*, RGBA*, COMMAND*);
#endif

#ifdef INCLUDE_TEX_ChamferRectangle
	void ChamferRectangle(RGBA*, RGBA*, COMMAND*);
#endif

#ifdef INCLUDE_TEX_Dots
	void Dots(RGBA*, RGBA*, COMMAND*);
#endif

#ifdef INCLUDE_TEX_Jpeg
	void Jpeg(RGBA*, RGBA*, COMMAND*);
#endif

	void PerformCommand(RGBA* Input, RGBA* Output, COMMAND* Parameters);
